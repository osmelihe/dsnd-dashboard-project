...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, entity_id, model):
        ...
        if model.name == "team":
            pred = prob_positive.mean()
            
        # Otherwise set `pred` to the first value
        # of the predict_proba output
        else:
            pred = prob_positive[0]
...
#changed this from serve()
if __name__ == "__main__":
    import uvicorn
    # This tells Uvicorn exactly where to find the 'app' object
    # and ensures it uses the correct import path.
    uvicorn.run("report.dashboard:app", host="127.0.0.1", port=5005, reload=True)
